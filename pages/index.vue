  ...
  <section>
    ...
    <div class="w-full p-3 box-border flex items-center gap-2">
      <button
        ...
        class="inline-block px-6 py-2.5 bg-blue-600 text-white text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-700 hover:shadow-lg transition duration-150 ease-in-out"
      ...
      <button
        @click="getMemberByToken()"
        class="shadow-md duration-150 text-pink-400 border-2 border-pink-400 rounded-2xl p-3 mt-5 hover:bg-pink-400 hover:text-white"
      >
        GET_MEMBER_BY_TOKEN
      </button>
    </div>
