  ...
  <section class="w-full lg:px-[50px]">
    ...
    >
      <ValidationObserver ref="form">
        ...
        <div class="form-group relative pb-6">
          ...
          >
            <input
              id="accountId"
              type="text"
              class="form-control w-full lg:w-1/2 px-3 py-1.5 text-gray-700 border-[1px] border-[#a3a3a3] rounded-[10px] transition ease-in-out focus:text-gray-700 focus:border-blue-600 focus:outline-none"
        ...
        <p class="text-[18px] mb-[7px]">連結帳號</p>
        <div class="space-y-[7px]">
          <div
            class="w-full lg:w-1/2 px-[17px] flex justify-between border-[1px] border-solid border-[#9A9999] rounded-[10px]"
          >
        ...
        <div class="flex justify-center">
          <button
            ...
            class="mt-[62px] duration-150 w-[236px] py-[17px] rounded-[10px] shadow-md text-white text-[18px] tracking-widest bg-gradient-to-r from-[#FF6D3F] to-[#FA5936] hover:shadow-inner disabled:cursor-not-allowed disabled:opacity-80"
            @click="handleSave()"
          >
            儲存
          </button>
