  ...
  <section class="w-full lg:px-[50px]">
    ...
    <form @submit.prevent="handleSearch()">
      <div class="lg:flex xl:justify-between">
        <div>
          <span
          class="block my-[10px] xl:inline xl:items-center xl:my-[0px]"
          >日期：</span>
        ...
        <div class="xl:flex">
          <span
          class="block my-[10px] xl:flex xl:items-center xl:my-[0px]"
          >訂單編號：</span>
          <input
          type="text"
    ...
    <div class="w-full mt-[35px] shadow-[0px_4px_4px_rgba(0,0,0,0.25)]">
      <div class="grid grid-cols-6">
        ...
        >
          ...
          border-b-[#fff]
          border-b-[5px]"
          :class="{'border-b-[#FA5936]': selectedList === list.name}"
