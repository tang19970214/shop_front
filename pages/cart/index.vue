<template>
  <section class="w-full md:px-8">
    ...
    <div class="flex justify-center lg:justify-end" v-if="cartList.length >= 1">
      <button data-mdb-ripple="true" data-mdb-ripple-color="light" class="mt-8 py-3.5 px-20 shadow-md text-white text-lg tracking-widest rounded-xl bg-gradient-to-r from-[#FF6D3F] to-[#FA5936] hover:shadow-inner disabled:cursor-not-allowed disabled:opacity-80" @click="$router.push({ name: 'cart-checkout' })">立即結帳</button>
    </div>
