<template>
  <section>
    <div class="relative w-full promoteArea">
      ...
      <button @click="changeImg(false)" class="absolute -left-4 xl:-left-12 top-1/3 -translate-y-3 w-8 h-8 rounded-full bg-[rgba(231,231,231,0.79)] p-2.5 flex justify-center items-center duration-300 hover:bg-[#FA5936] group">
        <fa icon="fa-solid fa-angle-left" class="text-black duration-300 group-hover:text-white"></fa>
      </button>
      <button @click="changeImg(true)" class="absolute -right-4 xl:-right-12 top-1/3 -translate-y-3 w-8 h-8 rounded-full bg-[rgba(231,231,231,0.79)] p-2.5 flex justify-center items-center duration-300 hover:bg-[#FA5936] group">
