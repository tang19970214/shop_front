<template>
  <section>
    <transition name="fade">
      <div v-if="isOpen" @click="closeZoom($event)" class="fixed w-screen h-screen top-0 left-0 bg-[rgba(64,64,64,0.6)] z-40 flex items-center justify-center">
        <div class="w-72 md:w-[400px] relative">
          ...
          <div class="relative w-full">
            <VueSlickCarousel :arrows="false" :slidesToShow="4" ref="c2" :asNavFor="$refs.c1" :focusOnSelect="true" class="-mx-1">
