<template>
  <div>
    ...
    <table class="w-full relative">
      ...
      <div v-if="isOverFiveItems && !isShowTotalItems" class="cursor-pointer absolute flex justify-center items-end pb-4 bottom-0 left-0 w-full h-[250px] bg-gradient-to-b from-transparent to-[rgba(251,238,223,0.87)]" @click.prevent="isShowTotalItems = true">
